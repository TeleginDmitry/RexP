...
export const StoryModal = ({
    ...
    return activeStory ? (
        <Modal
            ...
            style={{
                backgroundColor: activeStory
                    ? activeStory.story.backgroundColor
                    : ''
            }}
            classNames={{ header: s.modalHead, body: s.body, wrapper: s.modal }}
            size={'full'}
            isOpen={isOpen}
            onClose={onBack}
        >
                    ...
                    <ModalHeader className={'flex flex-row gap-2'}>
                        {activeStory.story.pages.map((x, k) => (
                            <Progress
                                ...
                                classNames={{
                                    base:
                                        activeStory.story.progressColor === 0
                                            ? s['track-black']
                                            : s['track-white'],
                                    indicator:
                                        activeStory.story.progressColor === 0
                                ...
                                key={x.id}
                                color={activeStory.story.progressColor}
                                size='sm'
                                maxValue={8}
                                minValue={0}
                                value={
