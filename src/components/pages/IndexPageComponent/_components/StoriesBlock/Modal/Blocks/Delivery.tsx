  ...
  (
    ...
    >
      <SwiperSlide style={{color: Story.story.textColor}} className={s["modal-body"]}>
        ...
        >
          Как Rex доставит твой товар?
        </div>

        <div
          className={s['modal-text']}
        >
          Надёжно и быстро. Мы гарантируем, что твой заказ доедет в целости и сохранности
          <span style={{color:"#F633F6"}}>примерно за 3 недели</span> благодаря работе опытных специалистов транспортной компании
        </div>
      ...
      <SwiperSlide style={{color: Story.story.textColor}} className={s["modal-body"]}>
        ...
        >
          <div className={s.list}>
            ...
            <div className={`${s["list-row"]}  ${s["list-row__black"]}`}>
              Получение товара в пункте выдачи заказов, который расположен ближе всего к твоему адресу
            </div>
          </div>
        </div>
      </SwiperSlide>
      <SwiperSlide style={{color: Story.story.textColor}} className={s["modal-body"]}>
        ...
        <div
          className={`${s['modal-text']} ${s["modal-center"]}`}
        >
          Не стесняйся обращаться к нам с любыми вопросами — мы всегда готовы помочь тебе с доставкой
        </div>
      </SwiperSlide>
    </Swiper>
  )
