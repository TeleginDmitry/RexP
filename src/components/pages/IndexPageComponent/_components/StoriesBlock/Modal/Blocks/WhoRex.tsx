    ...
    >
        ...
        >
            ...
            <Image
                ...
                height={100}
            />
            <div className={s['modal-title']}>Кто такой Rex?</div>

            <div className={s['modal-text']}>
                Rex – твой персональный помощник в мире моды и крутых образов.
                Он предлагает более 20 000 товаров. Но и это ещё не всё!
                <br />
                <br />
                Rex может доставить тебе любой товар из каталога Poizon (к
                слову, там более 4 000 000 позиций). Просто воспользуйся
                функцией «Rex найдёт»
            </div>
        </SwiperSlide>
        <SwiperSlide
        ...
        >
            ...
            <div className={s['modal-text']}>
                Конечно! За оригинальность товаров переживать не стоит, все
                строго проверяется
                <br />
                <br />
