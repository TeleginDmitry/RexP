  ...
  (
    ...
    >
      <SwiperSlide style={{color: Story.story.textColor}} className={s["modal-body"]}>
        ...
        <div
          className={`${s['modal-text']} ${s["row-gap"]}`}
        >
          <div className={s["text-block"]}>
            <span  style={{color:"#F633F6"}}>Измерь свои параметры</span>
            <span>Длину стопы — для заказа обуви; окружность талии, груди и бёдер — для заказа одежды</span>
          </div>
          <div className={s["text-block"]}>
            <span style={{color:"#F633F6"}}>Учитывай особенности</span>
            <span>Некоторые бренды могут выпускать модели, которые немного больше или меньше русского размера</span>
          </div>
        </div>
      ...
      <SwiperSlide style={{color: Story.story.textColor}} className={s["modal-body"]}>
        ...
        >
          <div className={s["text-block"]}>
            <span style={{color:"#F633F6"}}>Основной размер у нас — EUR</span>
            <span>EUR — обычно на 1 деление больше русского. Например, если ты носишь 40, значит в EUR размере — 41</span>
          </div>
        </div>
      </SwiperSlide>
    </Swiper>
