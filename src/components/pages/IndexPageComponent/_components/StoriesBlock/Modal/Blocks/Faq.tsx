    ...
    >
        ...
        >
            ...
            <div className={s['modal-text']}>
                Не беда! Rex-помощник уже спешит тебе на помощь! Не стесняйся
                задавать ему любые вопросы ;)
                <br /> <br />
                Например, если ты столкнулся со сложностью поиска желанного
                товара на Poizon, просто напиши в чат. Команда Рекса обязательно
                найдет товар и поможет оформить заказ!
            </div>
        </SwiperSlide>
        <SwiperSlide
            style={{ color: Story.story.textColor }}
        ...
        >
            ...
            <Image
                ...
                height={100}
            />
            <div className={s['modal-title']}>А где найти Rex-чат?</div>
            ...
            <div className={s['modal-text']}>
                ...
                <div className={s.list}>
                    ...
                    <div className={s['list-row']}>
                        Сообщи о проблеме в чате и ожидай ответ. Рекс и его
                        команда совсем скоро тебе помогут :)
                    </div>
                </div>
            </div>
        </SwiperSlide>
