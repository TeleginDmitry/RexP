  ...
  return (
    <div className={s.wrapper}>
      {deliveryCarts.length &&
        deliveryCarts.map(({ id, firstName, lastName, patronymic, number, deliveryType, isMain, address }, index) => (
          <div className={clsx(s.address, isMain && s.active)} key={index}>
            ...
            <div className={s.content}>
              ...
              <div className={s.phone}>+{number}</div>
              <div className={s.title}>Адрес доставки</div>
              <div className={s.addressValue}>{address}</div>
            </div>
            {!isMain && (
