              ...
              <div className="flex flex-col gap-3 pb-4 border-b border-solid border-[#EEEEEE]">
                <div className="flex gap-3 items-center">
                  ...
                  <p className="text-base text-black cursor-pointer">
                    Скачайте приложение Poizon и <span className="text-[#8E8E8E] underline">зарегистрируйтесь</span>
                  </p>
                </div>
                <div className="flex items-center gap-3 justify-center">
                  ...
                  >
                    ...
                    <p className="text-xs text-black">
                      Скачать <br />
                      из <span className="font-bold">App Store</span>
                    </p>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <p className="text-xs text-black">
                      Скачать <br />
                      из <span className="font-bold">Play Market</span>
                    </p>
                  </a>
                </div>
              </div>
